...
download_rootfs: _need_wget _need_unxz
	...
	set -x ; \
	$(call wget,tt-bh-disk-image.zip,https://github.com/tenstorrent/tt-bh-linux/releases/download/v0.7/tt-bh-disk-image.zip)
...
download_prebuilt: _need_wget _need_unzip
	...
	$(call wget,tt-bh-linux.zip,https://github.com/tenstorrent/tt-bh-linux/releases/download/v0.7/tt-bh-linux.zip)
